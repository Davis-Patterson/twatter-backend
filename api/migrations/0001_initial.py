...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('notification_type', models.CharField(choices=[('tag', 'Tag'), ('like_post', 'Like on Post'), ('like_comment', 'Like on Comment'), ('follow', 'Follow'), ('follow_request', 'Follow Request')], max_length=20)),
